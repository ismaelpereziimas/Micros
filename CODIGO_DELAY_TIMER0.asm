...
END ; ES IMPORTANTE PONER END, YA QUE SIN ESTO NO COMPILA EL PROGRAMALIST P=18F4550		;Directiva para definir el procesador
	#include <P18F4550.INC>	;Definicion de SFRs para el procesador
...
Main
   ...
   LED
    ...
    DELAY
    MOVLW B'10000111' ; se configura el timer0
    MOVWF T0CON         

    MOVLW B'11111110'  ;Se carga la cuenta en los registros
